...
- Team project 2 (30 points)
  ...
  - Project presentation: 7 points - Project 2b
  - Project code and doc repository created/maintained in GitHub: 9 points
  - Final report and other deliverables: 9 points - Project 2c
...
## Course Communication and Student Collaboration Policy

Official course announcements, policy changes, and gradebook data will be distributed exclusively via Sakai, which serves as the sole source of truth for this course. For team collaboration and individual communication with the TA and instructor, students are free to collaborate using either MS Teams (via direct group chat) or Discord. The instructor will not create, manage, or monitor any course-wide group servers or chat channels on these platforms. When project teams are formed later in the semester, teams may choose to invite the instructor to their specific collaboration space for guidance or code review; however, the teaching staff will only join via MS Teams (using the instructor's university email address) or Discord. The instructor will not join or monitor any other third-party applications (such as Slack, GroupMe, WhatsApp, etc.). Regardless of the platform chosen, all peer-to-peer communication and code sharing remain strictly governed by the University Student Code of Conduct and Academic Integrity policies. Any documented instances of academic dishonesty, harassment, or other unacceptable conduct on these platforms will immediately be reported to the competent authorities within the university.
